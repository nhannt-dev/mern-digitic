...
import { Profile, MemberLayout, Cart, History, Wishlist } from './pages/member'
const { ALL, HOME, LOGIN, PUBLIC, BLOGS, OUR_SERVICES, DETAIL_PRODUCT__CATEGORY__PID__TITLE, PRODUCTS, FINAL_REGISTER, RESET_PASSWORD, ADMIN, MANAGE_USER, MANAGE_ORDER, MEMBER, PROFILE, CREATE_PRODUCT, DASHBOARD, MANAGE_PRODUCTS, CART, HISTORY, WISHLIST } = path
